...
public class Servidor extends UnicastRemoteObject implements InterfaceXadrez {
    ...
    public boolean ordenaTabuleiro() throws RemoteException {
        ...
        for (int i = 0; i < utilizadores.size(); i++) {
            if (utilizadores.get(i) != null) {
                utilizadores.get(i).getReferencia().alteraTabuleiroAposJogo(tipoCor, tipoCorTabuleiroFantasma, utilizadores.get(i).getObjRemoto(), null);
            }
        }
        return true;
    }
    ...
    public JogadorCaracteristicas Jogador(JogadorCaracteristicas jogador) throws RemoteException {
        ...
        if (!verificaNome(jogador.getNome())) {
            if (mensagens != null) {
                tamanho = mensagens.size();
            }
            if (utilizadores == null) {
                utilizadores = new ArrayList<JogadorCaracteristicas>();
            }
            ...
            for (int i = 0; i < utilizadores.size(); i++) {
                if (!utilizadores.get(i).getNome().equalsIgnoreCase(jogador.getNome())) {
                    utilizadores.get(i).getReferencia().utilizadoresAltera(jogador, 0);
                }
            }
        } else {
            jogador.setIndex(-1);
    ...
    public JogadorCaracteristicas observar(JogadorCaracteristicas jogador) throws RemoteException {
        ...
        for (int i = 0; i < utilizadores.size(); i++) {
            if (utilizadores.get(i) != null) {
                ...
                if (utilizadores.get(i).isTipoJogador() == 1 || utilizadores.get(i).isTipoJogador() == 2) {
                    observa = -1;
                }
            }
        ...
        if (observa == -1) {
            ...
            for (int i = 0; i < utilizadores.size(); i++) {
                if (utilizadores.get(i) != null) {
                    utilizadores.get(i).getReferencia().utilizadoresAltera(jogador, tipoAntigo);
                }
            }
            return jogador;
        }
    ...
    public boolean adicionaMensagem(Mensagem mensagem) throws RemoteException {
        ...
        for (int i = 0; i < utilizadores.size(); i++) {
            if (utilizadores.get(i) != null) {
                utilizadores.get(i).getReferencia().mensagensAltera(mensagem);
            }
        }
        return true;
    }
    ...
    public JogadorCaracteristicas sentar(JogadorCaracteristicas jogador, int cadeira) throws RemoteException {
        ...
        for (int i = 0; i < utilizadores.size(); i++) {
            if (utilizadores.get(i) != null) {
                ...
                if (utilizadores.get(i).isTipoJogador() == 1) {
                    cadeira1 = 1;
                }
                if (utilizadores.get(i).isTipoJogador() == 2) {
                    cadeira2 = 2;
                }
            }
    ...
    public void desconectar(String nome) throws RemoteException {
        ...
        for (int i = 0; i < utilizadores.size(); i++) {
            if (utilizadores.get(i) != null) {
                if (utilizadores.get(i).getNome().equalsIgnoreCase(nome)) {
                    posicaoArray = i;
                    tipoAntigo = utilizadores.get(i).isTipoJogador();
                }
            }
        }
        if (utilizadores.size() > posicaoArray) {
        ...
        for (int i = 0; i < utilizadores.size(); i++) {
            if (utilizadores.get(i) != null) {
                utilizadores.get(i).getReferencia().utilizadoresAltera(new JogadorCaracteristicas(nome, 0, null, null, 0), tipoAntigo);
            }
    ...
    public boolean verificaNome(String aNome) {
        ...
        if (utilizadores != null) {
            for (int i = 0; i < utilizadores.size(); i++) {
                if (utilizadores.get(i) != null) {
                    if (utilizadores.get(i).getNome().equalsIgnoreCase(aNome)) {
                        return true;
                    }
                }
            }
